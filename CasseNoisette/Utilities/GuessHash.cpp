...
map<string, string> GuessHash::hashFunction_regex_map = { make_pair("MD5", "^[a-fA-F0-9]{32}$"),
                                                          make_pair("SHA-1", "^[a-fA-F0-9]{40}$"),
												          make_pair("SHA-256", "^[a-fA-F0-9]{64}$"),
												          make_pair("SHA-512", "^[a-fA-F0-9]{128}$") };
